    ...
    function assignSubscription($id)
    {
        ...
        if ($subscription) {
            ...
            if ($subscription->interval == 'Monthly') {
                uth::user()->subscription_expire_date = Carbon::now()->addMonths(1)->isoFormat('YYYY-MM-DD');
...
if (!function_exists('lockerPrefix')) {
    function lockerPrefix()
    {
        $settings = settings();
        return $settings["locker_number_prefix"];
    }
}
        ...
        $templateData = [
            ...
            'trainer_create' =>
                [
                    ...
                    'name' => 'New Trainer',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{new_user_name}', '{app_link}', '{username}', '{password}'],
                    'subject' => 'Welcome to {company_name} – Your Trainer Account Details!',
                    'templete' => '
                <p><strong>Dear {new_user_name},</strong></p><p>&nbsp;</p><blockquote><p>Welcome to {company_name}! We are thrilled to have you as part of our trainer community. We are confident you will have a great experience with us, and we look forward to supporting you in your journey.</p><p>If you have any questions or need assistance, our team is here to help. Please do not hesitate to reach out.</p><p>&nbsp;</p><p>Your account details are as follows:</p><p><strong>App Link:</strong> <a href="{app_link}" target="_blank">{app_link}</a></p><p><strong>Username:</strong> {username}</p><p><strong>Password:</strong> {password}</p><p>&nbsp;</p><p>Once logged in, you will be able to manage your trainer profile and access all the tools you need to succeed.</p>    <p>&nbsp;</p><p>Thank you for choosing {company_name}. We are excited to have you on board!</p></blockquote><p>Best regards,</p><p><strong>{company_name}</strong></p><p>{company_email}</p><p>{company_phone_number}</p><p>{company_address}</p><p>&nbsp;</p>
            ',
                ],
            'trainee_create' =>
                [
                    ...
                    'name' => 'New Trainee',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{new_user_name}', '{app_link}', '{username}', '{password}', '{membership}', '{membership_start_date}', '{trainer}'],
                    'subject' => 'Welcome to {company_name} – Your Trainee Account Details!',
                    'templete' => '
            <p><strong>Dear {new_user_name},</strong></p><p>&nbsp;</p><blockquote><p>Welcome to {company_name}! We are excited to have you join our community. Whether you are here to improve your skills, meet your fitness goals, or simply explore, we are committed to providing you with an exceptional experience.</p><p>If you have any questions or need assistance, please do not hesitate to reach out. Our team is here to support you every step of the way!</p><p>&nbsp;</p><p>Your account details are as follows:</p><p><strong>App Link:</strong> <a href="{app_link}" target="_blank">{app_link}</a></p><p><strong>Username:</strong> {username}</p><p><strong>Password:</strong> {password}</p><p>&nbsp;</p><p><strong>Membership Plan:</strong> {membership}</p><p><strong>Membership Start Date:</strong> {membership_start_date}</p><p><strong>Assigned Trainer:</strong> {trainer}</p><p>&nbsp;</p><p>Once you log in, you will have access to all the tools you need to track your progress, interact with your trainer, and achieve your goals.</p><p>&nbsp;</p><p>Thank you for choosing {company_name}. We are excited to be a part of your journey and look forward to supporting you in achieving success!</p></blockquote><p>Best regards,</p><p><strong>{company_name}</strong></p><p>{company_email}</p><p>{company_phone_number}</p><p>{company_address}</p><p>&nbsp;</p>
            ',
                ],
            'trainer_assign' =>
                [
                    ...
                    'name' => 'Trainer Assign',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{trainee_name}', '{membership}', '{membership_start_date}', '{trainer_name}'],
                    'subject' => 'New Trainee Assigned to You – {trainee_name}!',
                    'templete' => '
                <p><strong>Dear {trainer_name},</strong></p><p>&nbsp;</p><blockquote><p>We are excited to inform you that a new trainee has been assigned to you! Below are the details for your new trainee:</p><p><strong>Trainee Name:</strong> {trainee_name}</p><p><strong>Phone Number:</strong> {phone_number}</p><p><strong>Membership Plan:</strong> {membership}</p><p><strong>Membership Start Date:</strong> {membership_start_date}</p><p>&nbsp;</p><p>Please reach out to {new_user_name} to introduce yourself and begin the training journey together. If you need any additional information or support, feel free to contact us!</p><p>&nbsp;</p><p>Thank you for being a valued trainer at {company_name}. We appreciate your commitment to helping our trainees succeed!</p></blockquote><p>Best regards,</p><p><strong>{company_name}</strong></p><p>{company_email}</p><p>{company_phone_number}</p><p>{company_address}</p><p>&nbsp;</p>
            ',
                ],
            'new_classes' =>
                [
                    'module' => 'new_classes',
                    'name' => 'New Classes',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{class_name}', '{class_fees}', '{class_address}', '{class_schedule}'],
                    'subject' => 'New Classes Available at {company_name} – Join or Teach Today!',
                    'templete' => '

            <blockquote><p>We are thrilled to announce that {company_name} is offering new classes for you to explore and join! Whether you’re a trainee looking to enroll or a trainer preparing to teach, we have exciting opportunities for you.</p><p>&nbsp;</p><p><strong>Class Details:</strong></p><p><strong>Class Name:</strong> {class_name}</p><p><strong>Class Fees:</strong> {class_fees} {company_currency}</p><p><strong>Class Location:</strong> {class_address}</p><p><strong>Class Schedule:</strong>&nbsp;</p><p>{class_schedule}</p><p>&nbsp;</p><p><strong>If you are a trainee:</strong> To enroll in this class, please log in to your account and follow the instructions to reserve your spot.</p><p><strong>If you are a trainer:</strong> You’ve been assigned to teach this class, and we know your expertise will make it a great success! Please reach out to your trainees to get started and prepare for the sessions.</p><p>&nbsp;</p><p>We are excited to have you with us and look forward to supporting you on your journey. If you have any questions or need assistance, feel free to reach out to our team at any time!</p><p>&nbsp;</p><p>Thank you for being a part of {company_name}. We’re looking forward to seeing you in action, whether you’re learning or teaching!</p></blockquote><p>Best regards,</p><p><strong>{company_name}</strong></p><p>{company_email}</p><p>{company_phone_number}</p><p>{company_address}</p><p>&nbsp;</p>
            ',
                ],
            'workout_create' =>
                [
                    ...
                    'name' => 'Workout Create',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{start_date}', '{end_date}', '{activity_report}'],
                    'subject' => 'New Workout Plan Created for You at {company_name}!',
                    'templete' => '
                <p>&nbsp;</p><blockquote><p>We’re excited to inform you that a personalized workout plan has been created for you at {company_name}! This program is designed to help you reach your fitness goals with the support and guidance you need.</p><p>Here are the details of your new workout plan:</p><p><strong>Workout Start Date:</strong> {start_date}</p><p><strong>Workout End Date:</strong> {end_date}</p><p>&nbsp;</p><p><strong>Activity Report:</strong></p><p>{activity_report}</p><p>&nbsp;</p><p>To get started, log in to your account and begin your workout journey. If you need any assistance or modifications to your workout plan, feel free to reach out to us at any time.</p><p>&nbsp;</p><p>We’re here to support you every step of the way. Thank you for choosing {company_name} – we can’t wait to see you succeed!</p></blockquote><p>Best regards,</p><p><strong>{company_name}</strong></p><p>{company_email}</p><p>{company_phone_number}</p><p>{company_address}</p><p>&nbsp;</p>
            ...
            'health_update' =>
                [
                    ...
                    'name' => 'Health Update',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{trainee_name}', '{measurement_date}', '{health_report}'],
                    'subject' => 'Health Update for {trainee_name} – {company_name}',
                    'templete' => '
                <p><strong>Dear {trainee_name},</strong></p>
            <p>&nbsp;</p>
            <blockquote>
                <p>We hope you are continuing to progress toward your health and fitness goals at {company_name}!</p>
                <p>Here is your most recent health update:</p>
                <p><strong>Measurement Date:</strong> {measurement_date}</p>
                <p>&nbsp;</p>

                <!-- Combined Measurement Report in one shortcode -->
                <p><strong>Your Latest Measurement Report:</strong></p>
                <p>{health_report}</p> <!-- This single shortcode will contain the full measurement report -->

                <p>&nbsp;</p>
                <p>We encourage you to track your progress and maintain consistency. If you need any adjustments or have questions about your health plan, our team is here to support you.</p>
                <p>&nbsp;</p>
                <p>If you haven’t updated your measurements recently, please remember to do so for a more accurate progress report and to ensure you’re on the right track.</p>
                <p>&nbsp;</p>
                <p>Thank you for trusting {company_name} to be part of your wellness journey. We’re excited to continue supporting you!</p>
            </blockquote>
            ...
            'attendance_create' =>
                [
                    ...
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{date}', '{check_in_time}', '{check_out_time}'],
                    'subject' => 'Attendance Record for {user_name} – {company_name}',
                    'templete' => '
                <p><strong>Dear {user_name},</strong></p>
                <p>&nbsp;</p>
                <blockquote>
                    <p>We would like to confirm that your attendance has been successfully recorded at {company_name}.</p>
                    <p>Here are the details of your attendance for today:</p>
                    <p><strong>Date:</strong> {date}</p>
                    <p><strong>Check-In Time:</strong> {check_in_time}</p>
                    <p><strong>Check-Out Time:</strong> {check_out_time}</p>
                    <p>&nbsp;</p>
                    <p>We hope this information is helpful for your records. If you notice any discrepancies or if you have any questions about your attendance, please feel free to reach out to us at {company_email} or {company_phone_number}.</p>
                    <p>&nbsp;</p>
                    <p>Thank you for being a part of {company_name}. We look forward to continuing to support you!</p>
                </blockquote>
            ...
            'invoice_create' =>
                [
                    ...
                    'name' => 'Create Invoice',
                    'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{invoice_number}', '{invoice_date}', '{invoice_due_date}', '{amount}',],
                    'subject' => 'Invoice {invoice_number} from {company_name}',
                    'templete' => '
            <p><strong>Dear {user_name},</strong></p>
            <p>&nbsp;</p>
            <blockquote>
                <p>We hope you are doing well! This is to inform you that an invoice has been created for your recent transaction with {company_name}. Please find the details of your invoice below:</p>

                <p><strong>Invoice Number:</strong> {invoice_number}</p>
                <p><strong>Invoice Date:</strong> {invoice_date}</p>
                <p><strong>Invoice Due Date:</strong> {invoice_due_date}</p>
                <p><strong>Amount Due:</strong>{company_currency} {amount}</p>
                <p>&nbsp;</p>

                <p>We kindly request that you process this invoice by the due date mentioned above. If you have any questions or require further assistance, please do not hesitate to contact us at {company_email} or {company_phone_number}.</p>

                <p>&nbsp;</p>
                <p>Thank you for choosing {company_name}. We appreciate your business and look forward to continuing our relationship with you.</p>
            </blockquote>
            ...
            'locker_assign' => [
                ...
                'name' => 'Locker Assign',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{locker_id}'],
                'subject' => 'New Locker Assigned to You – {user_name}!',
                'templete' => '
                    <p><strong>Dear {user_name},</strong></p>
                    <p>We are pleased to inform you that locker <strong>#{locker_id}</strong> has been successfully assigned to you.</p>
                    <p>Please make sure to use the locker responsibly and Follow the rules to all locker usage guidelines provided by <strong>{company_name}</strong>.</p>
...
if (!function_exists('MessageReplace')) {
    function MessageReplace($notification, $id = 0)
    {
        ...
        if (!empty($notification)) {
            ...
            if ($notification->module == 'trainer_create') {
                $user = User::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{new_user_name}', '{app_link}', '{username}', '{password}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $user->name, env('APP_URL'), $user->email, $notification['password']];
            }
            if ($notification->module == 'trainee_create') {
                $user = User::find($id);
            ...
            if ($notification->module == 'new_classes') {
                ...
                $schedule = $notification->scheduleMessage;
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{class_name}', '{class_fees}', '{class_address}', '{class_schedule}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $class->title, $class->fees, $class->address, $schedule];
            }
            if ($notification->module == 'workout_create') {
                $workout = Workout::find($id);
                $activity = $notification->activity;
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{start_date}', '{end_date}', '{activity_report}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], dateFormat($workout->start_date), dateFormat($workout->end_date), $activity];
            }
            if ($notification->module == 'health_update') {
                $health = Health::find($id);
                $user = User::find($health->user_id);
                $result = $notification->result;
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{trainee_name}', '{measurement_date}', '{health_report}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $user->name, dateFormat($health->measurement_date), $result];
            }
            if ($notification->module == 'attendance_create') {
                $attendance = Attendance::find($id);
                $user = User::find($attendance->user_id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{date}', '{check_in_time}', '{check_out_time}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $user->name, dateFormat($attendance->date), timeFormat($attendance->checked_in_time), timeFormat($attendance->checked_out_time)];
            }
            if ($notification->module == 'invoice_create') {
                $invoice = Invoice::find($id);
                $amount = InvoiceItem::where('invoice_id', $invoice->id)->sum('amount');
                $user = User::find($invoice->user_id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{invoice_number}', '{invoice_date}', '{invoice_due_date}', '{amount}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $user->name, invoicePrefix() . $invoice->invoice_id, dateFormat($invoice->invoice_date), dateFormat($invoice->invoice_due_date), $amount];
            }
            if ($notification->module == 'locker_assign') {
    ...
    function HomePageSection()
    {
        $retuen = [
            ...
            [
                'title' => 'Banner',
                'section' => 'Section 1',
                'content_value' => '{"name":"Banner","section_enabled":"active","title":"FitHub SaaS - Gym Management Tool","sub_title":"FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","btn_name":"Get Started","btn_link":"#","section_footer_text":"Manage your business efficiently with our all-in-one solution designed for performance, security, and scalability.","section_main_image":{},"section_footer_image_path":"upload\/homepage\/banner_2.png","section_main_image_path":"upload\/homepage\/banner_1.png","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                <header id="home">
                    <div class="container">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-5 col-xl-4">
                                <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <span class="text-primary">FitHub SaaS - Gym Management Tool</span>
                                </h1>
                                <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                                    FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.
                                </h4>
                        ...
                        <div class="container">
                            <div class="row align-items-center g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-lg w-75 my-3 my-md-4">FitHub SaaS has made it easy for developers of any skill level to
                                        use their product.</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">FitHub SaaS has conceptul working apps like Chat, Inbox, E-commerce, Invoice,
            ...
            [
                'title' => 'Core Features',
                'section' => 'Section 6',
                'content_value' => '{"name":"Core Features","section_enabled":"active","Sec6_title":"Core Features","Sec6_info":"Core Modules For Your Business","Sec6_Box_title":["Dashboard","Trainer","Trainee","Invoice Details","Expense"],"Sec6_Box_subtitle":["FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym."],"Sec6_box_image":[{},{},{},{},{}],"section_footer_image_path":"","section_main_image_path":"","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec6_box0_image_path":"upload\/homepage\/1.png","Sec6_box1_image_path":"upload\/homepage\/2.png","Sec6_box2_image_path":"upload\/homepage\/3.png","Sec6_box3_image_path":"upload\/homepage\/4.png","Sec6_box4_image_path":"upload\/homepage\/5.png","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">FitHub SaaS has conceptul working apps like Chat, Inbox, E-commerce, Invoice, Kanban,
                                    and Calendar</p>
                            </div>
                        </div>
                        <div class="row text-center justify-content-center">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-9">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <h2 class="mb-0 text-white">Choose FitHub SaaS for</h2>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col-12">
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        ...
                                        <b>Is FitHub SaaS Support Typescript?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        Yes, FitHub SaaS Support the TypeScript and it is only available in Plus and Extended License.
                                        </div>
                                    </div>
                                    </div>
                                    <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingfour">
                                        ...
                                        <b>Is there any Road map for FitHub SaaS?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapse-four" class="accordion-collapse collapse" aria-labelledby="flush-headingfour"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        FitHub SaaS is our flagship React Dashboard Template and we always add the new features for the long
                                        run. You can check
            ...
            [
                ...
                'section' => 'Section 10',
                'content_value' => '{"name":"AboutUS - Footer","section_enabled":"active","Sec10_title":"About FitHub SaaS","Sec10_info":"FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.","section_footer_image_path":"","section_main_image_path":"","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <h4 class="my-3 text-white">About FitHub</h4>
                            ...
                            <div class="col-md-8">
                                <div class="row g-4">
                                    ...
                                    <div class="col-6 col-md-3 wow fadeInUp" data-wow-delay="0.6s">
                                        <h5 class="mb-3 mb-sm-4 text-white">FitHub SaaS Eco-System</h5>
                                        <ul class="list-unstyled footer-link">
...
if (!function_exists('NewPermission')) {
    ...
    {
        $permissions = [
            ['name' => 'manage locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit lokcer', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'delete locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'show locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create assign locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit assign locker', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'manage event type', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create event type', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit event type', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'delete event type', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'show event type', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'manage event', 'guard_name' => 'web', 'roles' => ['owner', 'trainer', 'trainee', 'manager']],
            ['name' => 'create event', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit event', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'delete event', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'show event', 'guard_name' => 'web', 'roles' => ['owner', 'tranier', 'trainee']],
            ['name' => 'manage nutrition schedule', 'guard_name' => 'web', 'roles' => ['owner', 'tranier', 'trainee', 'manager']],
            ['name' => 'craete nutrition schedule', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit nutrition schedule', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'show nutrition schedule', 'guard_name' => 'web', 'roles' => ['owner', 'manager' ,'tranier', 'trainee']],
            ['name' => 'delete nutrition schedule', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create bulk attendance', 'guard_name' => 'web', 'roles' => ['owner', 'manager', 'trainer']],
            ['name' => 'manage invoice', 'guard_name' => 'web', 'roles' => ['trainee']],
            ['name' => 'manage product', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create product', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'edit product', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'show product', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'delete product', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'manage product booking', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'create product booking', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
            ['name' => 'delete product booking', 'guard_name' => 'web', 'roles' => ['owner', 'manager']],
        ];
