...
<form method="post" action="{{ route('theme.settings') }}">
    ...
    <input type="hidden" name="color_type" id="color_type" value="{{ $settings['color_type'] ?? 'preset' }}"> <input
        type="hidden" name="layout_width" id="layout_width" value="{{ $settings['layout_width'] }}">
