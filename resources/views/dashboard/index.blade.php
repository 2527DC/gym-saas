...
<script>
    var options = {
        ...
        series: [
            {
                name: "Income",
                data: {!! json_encode(@$result['organizationByMonth']['income']) !!}
            },
            {
                name: "Expense",
                data: {!! json_encode(@$result['organizationByMonth']['expense']) !!}
            }
        ],
        xaxis: {
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1">{{ __('Total Trainer') }}</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ $result['totalTrainer'] }}</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1">{{ __('Today Income') }}</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ priceFormat($result['todayIncome']) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1">{{ __('Today Expense') }}</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ priceFormat($result['todayExpense']) }}
                                </h4>
                            </div>
                        </div>
                    </div>
