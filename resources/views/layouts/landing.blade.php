                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            @else
                                {{ __('Law Practice SaaS - Legal Advocate & Counsel Manager') }}
                            @endif
                        </h1>
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            @else
                                {{ __('An Legal Advocate & Counsel Manager is a comprehensive software solution designed to streamline and enhance the operations of legal professionals and law firms. This system provides an integrated platform to manage the entire lifecycle of legal cases, from client intake and case tracking to document management and billing.') }}
                            @endif
                        </h4>
                        @php
                    ...
                    <div class="row align-items-center g-4">
                        @if ($is3 % 2 != 0)
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                @else
                                    <img src="{{ Storage::url('upload/homepage/img-customize-1.svg') }}"
                                        alt="img" class="img-fluid w-75" />
                                @endif
                            </div>
                        @endif
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable">{{ __('Client Limit') }}
                                                {{ $subscription->client_limit }}</li>
                                            <li class="list-group-item enable">{{ __('Advocate Limit') }}
                                                {{ $subscription->advocate_limit }}</li>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                @else
                                    <div class="swiper-slide">
                                        ...
                                        <p>{{ __('An Legal Advocate & Counsel Manager is a comprehensive software solution designed to streamline and enhance the operations of legal professionals and law firms.') }}
                                        </p>
                                    </div>
                                    <div class="swiper-slide">
