                        ...
                        <div class="mb-4 mb-lg-0 d-inline-flex align-items-center wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0 text-start">
                                    ...
                                    @else
                                        <b>Copyright 2025</b>
                                        © - Smart Tenant All rights reserved
                                    @endif
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable">{{ __('Trainer Limit') }}
                                                {{ $subscription->trainer_limit }}</li>
                                            <li class="list-group-item enable">{{ __('Trainee Limit') }}
                                                {{ $subscription->trainee_limit }}</li>
