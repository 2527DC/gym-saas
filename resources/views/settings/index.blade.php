                                ...
                                @if (Gate::check('manage company settings'))
                                    <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('trainer_number_prefix', __('Trainer Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('trainer_number_prefix', $settings['trainer_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter trainer prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
                                                {{ Form::label('trainee_number_prefix', __('Trainee Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('trainee_number_prefix', $settings['trainee_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter trainee number prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                <label class="form-label">
                                                    ...
                                                    @else
                                                        {{ __('2-factors authentication is currently') }}
                                                        <span class='badge bg-success'>{{ __('enable') }}</span>. <a
                                                            href="{{ route('2fa.disable') }}"><span
                                                                class='badge bg-danger'>{{ __('click to disabled') }}</span></a>
                                                    @endif
                                                </label>
                                            </div>
                                            <div class="col-12">
