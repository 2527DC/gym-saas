        ...
        <div class="col-sm-12">
            <div id="basicwizard" class="form-wizard row justify-content-center">
                <div class="col-12">
                    ...
                    {{ Form::open(['route' => 'trainees.store', 'method' => 'post', 'id' => 'businessForm', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 mb-3">
                                                        ...
                                                        {{ Form::number('phone_number', null, ['class' => 'form-control', 'placeholder' => __('Enter phone number'), 'required' => 'required', 'pattern' => '[0-9]*', 'inputmode' => 'numeric', 'oninput' => 'this.value = this.value.replace(/[^0-9]/g, "")', 'maxlength' => 15, 'minlength' => 10]) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('dob', __('Date of Birth') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                        {{ Form::date('dob', null, ['class' => 'form-control', 'placeholder' => 'Select Date of Birth', 'required' => 'required', 'onchange' => 'calculateAge(this.value)']) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('age', __('Age'), ['class' => 'form-label']) }}
                                                        {{ Form::number('age', null, ['class' => 'form-control', 'placeholder' => __('Enter age'), 'required' => 'required', 'readonly' => true, 'id' => 'age']) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                ...
                                <div class="tab-pane" id="addressDetail">
                                    <div id='addressDetailForm'>
                                        <div class="row mt-4">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                {{ Form::label('zip_code', __('Zipcode'), ['class' => 'form-label']) }}
                                                {{ Form::text('zip_code', null, ['class' => 'form-control', 'placeholder' => __('Enter zip code')]) }}
                                            </div>
                                            <div class="form-group col-md-6 mb-3">
                                                {{ Form::label('address', __('Address'), ['class' => 'form-label']) }}
                                                {{ Form::textarea('address', null, ['class' => 'form-control', 'rows' => 1, 'placeholder' => __('Enter address')]) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="additionalDetail">
                                    <div id='additionalDetailForm'>
                                        <div class="row mt-4">
                                            <div class="form-group col-md-6 mb-3">
                                                {{ Form::label('fitness_goal', __('Fitness Goal') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                {{ Form::text('fitness_goal', null, ['class' => 'form-control', 'placeholder' => __('Enter fitness goal')]) }}
                                            </div>
                                            <div class="form-group col-md-6 mb-3">
                                                {{ Form::label('category', __('Category') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                {!! Form::select('trainer_assign', $trainer, null, ['class' => 'form-control select2 select2']) !!}
                                            </div>
                                            <div class="form-group col-md-6 mb-3">
                                                {{ Form::label('assign_class', __('Classes'), ['class' => 'form-label']) }}
                                                {!! Form::select('assign_class', $classes, null, ['class' => 'form-control select2 select2']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
