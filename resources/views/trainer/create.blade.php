        ...
        <div class="col-sm-12">
            <div id="basicwizard" class="form-wizard row justify-content-center">
                <div class="col-12">
                    ...
                    {{ Form::open(['url' => 'trainers', 'method' => 'post', 'id' => 'businessForm', 'enctype' => 'multipart/form-data']) }}
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 mb-3">
                                                        ...
                                                        {{ Form::text('phone_number', null, ['class' => 'form-control', 'placeholder' => __('Enter phone number'), 'required' => 'required', 'pattern' => '[0-9]{10,15}', 'inputmode' => 'numeric', 'oninput' => 'this.value = this.value.replace(/[^0-9]/g, "")', 'maxlength' => 15, 'minlength' => 10]) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('dob', __('Date of Birth') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                        {{ Form::date('dob', null, ['class' => 'form-control', 'required' => 'required', 'onchange' => 'calculateAge(this.value)']) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('gender', __('Gender') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                        {!! Form::select('gender', $gender, null, ['class' => 'form-control select2 select2', 'required' => 'required']) !!}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('qualification', __('Qualification') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                        {{ Form::text('qualification', null, ['class' => 'form-control', 'placeholder' => __('Enter qualification'), 'required' => 'required']) }}
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        {{ Form::label('assign_class', __('Classes') . '<span class="text-danger"> *</span>', ['class' => 'form-label'], false) }}
                                                        {!! Form::select('assign_class[]', $classes, null, [
