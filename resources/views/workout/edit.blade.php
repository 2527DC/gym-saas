...
<div class="modal-body wrapper">
    <div class="row">
        ...
        <div class="form-group col-md-12 assign trainee {{$workout->assign_to=='trainee'?'':'d-none'}}">
            ...
            {!! Form::select('trainee', $trainee, $workout->assign_id,array('class' => 'form-control select2')) !!}
        </div>
        <div class="form-group col-md-12  assign class {{$workout->assign_to=='class'?'':'d-none'}}">
            ...
            {!! Form::select('class', $classes, $workout->assign_id,array('class' => 'form-control select2')) !!}
        </div>
