            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <div class="price-card2">
                        <?php
                            $features = [__('User Limit'),__('Trainer Limit'),__('Trainee Limit'), __('Enabled Logged History'), __('Coupon Applicable')];
                        ?>
                                        ...
                                        <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="text-center">
                                                <?php switch($feature):
                                                    ...
                                                    <?php break; ?>
                                                    <?php case (__('Trainer Limit')): ?>
                                                    <?php echo e($subscription->trainer_limit); ?>

                                                    <?php break; ?>
                                                    <?php case (__('Trainee Limit')): ?>
                                                    <?php echo e($subscription->trainer_limit); ?>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit pricing packages')): ?>
                                        <a class="btn btn-icon btn-link-secondary customModal" data-bs-toggle="tooltip"
                                    ...
                                    <?php if($subscription->id != 1): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete pricing packages')): ?>
                                            <a class="btn btn-icon btn-link-danger confirm_dialog" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin/Downloads/gym software/resources/views/subscription/index.blade.php ENDPATH**/ ?>