                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif($transaction->payment_type=='Bank Transfer'): ?>
                                        ...
                                        <a class="btn btn-icon avtar-xs btn-link-primary" data-bs-toggle="tooltip" target="_blank"
                                        ...
                                        <?php if(\Auth::user()->type=='super admin' && $transaction->payment_status=='Pending'): ?>
                                            <a class="btn btn-icon avtar-xs btn-link-secondary" data-bs-toggle="tooltip"
                                            ...
                                            <a class="btn btn-icon avtar-xs btn-link-danger" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gym software\resources\views/subscription/transaction.blade.php ENDPATH**/ ?>