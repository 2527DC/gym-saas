                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::file('logo', ['class' => 'form-control', 'accept' => '.png'])); ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo e(asset(Storage::url('upload/logo')) . '/' . $settings['company_favicon']); ?>"
                                                        target="_blank"><i class="ti ti-eye ms-2 f-15"></i></a>
                                                    <?php echo e(Form::file('favicon', ['class' => 'form-control', 'accept' => '.png'])); ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo e(asset(Storage::url('upload/logo')) . '/' . $settings['light_logo']); ?>"
                                                        target="_blank"><i class="ti ti-eye ms-2 f-15"></i></a>
                                                        <?php echo e(Form::file('light_logo', ['class' => 'form-control', 'accept' => '.png'])); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="<?php echo e(asset(Storage::url('upload/logo/landing_logo.png'))); ?>"
                                                            target="_blank"><i class="ti ti-eye ms-2 f-15"></i></a>
                                                        <?php echo e(Form::file('landing_logo', ['class' => 'form-control', 'accept' => '.png'])); ?>
                                ...
                                <?php if(Gate::check('manage company settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('trainer_number_prefix', __('Trainer Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('trainer_number_prefix', $settings['trainer_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter trainer prefix')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('trainee_number_prefix', __('Trainee Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('trainee_number_prefix', $settings['trainee_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter trainee number prefix')])); ?>
                                            ...
                                            <div class="col-12">
                                                <label class="form-label">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <span class='badge bg-success'><?php echo e(__('enable')); ?></span>. <a
                                                            href="<?php echo e(route('2fa.disable')); ?>"><span
                                                                class='badge bg-danger'><?php echo e(__('click to disabled')); ?></span></a>
                                                    <?php endif; ?>
                                                </label>
                                            </div>
                                            <div class="col-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin/Downloads/gym software/resources/views/settings/index.blade.php ENDPATH**/ ?>