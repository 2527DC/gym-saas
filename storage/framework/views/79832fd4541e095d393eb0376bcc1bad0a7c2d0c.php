                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Law Practice SaaS - Legal Advocate & Counsel Manager')); ?>
                        ...
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('An Legal Advocate & Counsel Manager is a comprehensive software solution designed to streamline and enhance the operations of legal professionals and law firms. This system provides an integrated platform to manage the entire lifecycle of legal cases, from client intake and case tracking to document management and billing.')); ?>
                    ...
                    <div class="row align-items-center g-4">
                        <?php if($is3 % 2 != 0): ?>
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(Storage::url('upload/homepage/img-customize-1.svg')); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable"><?php echo e(__('Client Limit')); ?>

                                                <?php echo e($subscription->client_limit); ?></li>
                                            <li class="list-group-item enable"><?php echo e(__('Advocate Limit')); ?>

                                                <?php echo e($subscription->advocate_limit); ?></li>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        ...
                                        <p><?php echo e(__('An Legal Advocate & Counsel Manager is a comprehensive software solution designed to streamline and enhance the operations of legal professionals and law firms.')); ?>
...
<?php /**PATH /Users/admin/Downloads/gym software/resources/views/layouts/landing.blade.php ENDPATH**/ ?>