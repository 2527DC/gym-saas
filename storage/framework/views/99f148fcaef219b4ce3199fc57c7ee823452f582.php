...
<form method="post" action="<?php echo e(route('theme.settings')); ?>">
    ...
    <input type="hidden" name="color_type" id="color_type" value="<?php echo e($settings['color_type'] ?? 'preset'); ?>"> <input
        type="hidden" name="layout_width" id="layout_width" value="<?php echo e($settings['layout_width']); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/admin/Downloads/gym software/resources/views/admin/footer.blade.php ENDPATH**/ ?>